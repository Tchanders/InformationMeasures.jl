...
function getentropymaximumlikelihood(valuesX::Array{Float64,2}, valuesY::Array{Float64,2}, base=2)
	jointprobabilities = getprobabilitiesmaximumlikelihood(getjointfrequencies(valuesX, valuesY))
